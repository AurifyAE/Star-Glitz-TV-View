...
socket.on("connect", () => {
    ...
    requestMarketData(["GOLD", "SILVER", "COPPER", "PLATINUM"]);
});
...
let askSpread, bidSpread, silverBidSpread, silverAskSpread, goldBuy, goldAskingPrice, goldBiddingPrice, copperBuy, copperSell, platinumSell, platinumBuy,
    goldSell, silverBuy, silverSell, silverValue, goldHigh, goldLow, silverLow, silverHigh, silverAskingPrice, silverBiddingPrice, platinumBiddingPrice, platiunumAskingPrice,
    copperBiddingPrice, copperAskingPrice;
...
async function fetchData() {
 ...
 value = goldData.bid;
    ...
    copperAskingPrice = (copperSellUSD * 3.674).toFixed(4);

    var platinumBuyUSD = (platinumBuy / 31.103).toFixed(4);
